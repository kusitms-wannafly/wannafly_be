...
import com.kusitms.wannafly.command.category.service.CheckedCategoryService;
...
public class ApplicationItemService {
    ...
    public void registerCategory(Long categoryId, Long applicationItemId, LoginMember loginMember) {
        ...
        Category category = checkedCategoryService.checkAndGet(categoryId, loginMember.id());
