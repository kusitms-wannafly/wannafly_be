...
public class ApplicationFolderFixture {
    ...
    public static final ApplicationFolderCreateRequest FOLDER_CREATE_2022 = new ApplicationFolderCreateRequest(
            2022
    );
    public static final ApplicationFolderCreateRequest FOLDER_CREATE_2021 = new ApplicationFolderCreateRequest(
            2021
    );
}
