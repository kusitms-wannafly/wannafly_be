...
import com.kusitms.wannafly.command.applicationform.domain.value.ApplicationYear;
import com.kusitms.wannafly.command.applicationform.domain.value.Recruiter;
import com.kusitms.wannafly.command.applicationform.domain.value.Semester;
